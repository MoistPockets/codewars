// This kata is designed to test your ability to extend the functionality of built-in ruby classes. In this case,
...
Array.prototype.square =  function(arr){
    newArr = [];
    arr.forEach(function(i){newArr.push(Math.pow(i, 2));});
    return newArr;
};
Array.prototype.cube = function(arr){
    newArr = [];
    arr.forEach(function(i){newArr.push(Math.pow(i, 3));});
    return newArr;
};
Array.prototype.average = function(arr){
    avg = 0;
    arr.forEach(function(i){avg +=i;});
    return (avg/arr.length) ;
};
Array.prototype.sum = function(arr){
    total = 0;
    arr.forEach(function(i){total +=i;});
    return total;
};
Array.prototype.even = function(arr){
    newArr = [];
    arr.forEach(function(i){if(i%2===0){newArr.push(i);}});
    return newArr;
};
